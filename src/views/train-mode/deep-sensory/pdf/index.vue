 ...
 * @LastEditTime: 2023-10-26 15:15:09
      ...
      this.$axios
        ...
        .then(res => {
          ...
          if (data.status === 1) {
            ...
            this.pdfData.coreResultArray = JSON.parse(
              data.result.coreResultArray
            )
            this.pdfData.average = data.result.average
