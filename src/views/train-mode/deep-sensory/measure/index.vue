 ...
 * @LastEditTime: 2023-11-06 15:33:16
 * @Description : 本体感觉训练-具体测量
-->
<template>
  <div
    class="deep-sensory-measure"
    ...
    saveData() {
      ...
      this.$axios
        .post('/saveTrainRecord_v3', {
          ...
          coreResultArray: JSON.stringify(this.coreResultArray), // 多组的结果值数组
          average: average, // 平均值
        ...
        .catch(err => {
          this.$alert(
            `[本体感觉训练环节] ${err}。请确保网络连接正常，点击"返回上一页"按钮，然后重新测试！`,
            '网络请求错误',
            {
              type: 'error',
              showClose: false,
