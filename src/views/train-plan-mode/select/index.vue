...
<template>
  <div class="train-plan-select" v-loading.fullscreen.lock="fullscreenLoading">
    <div class="wrapper">
      ...
      <div class="main">
        <!-- 介绍说明 -->
        <div class="introduce">请选择训练项目</div>
...
export default {
  ...
  data() {
    return {
      ...
      /* 是否可选择 */
      isAbdominalRespiration: true, // 腹式呼吸训练
      isActivityImprovement: true, // 活动度训练
      isStabilizerActivation: true, // 内核心激活训练
      isDeepSensory: true, // 本体感觉训练
      isStatic: true, // 静态稳定训练
      isDynamic: true, // 动态稳定训练
